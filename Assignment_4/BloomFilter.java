...
class BloomFilter {
     ...
     *
     * Notice that Java's hash table implementation â€” and hence implementations
     * of hashCode() â€” don't require the goals above to be met. Java maps and 
    ...
    public boolean contains(String s) {
        for (int n = 0; n < noHashes; n++) {
            ...
            // If even one of the bits isn't set, it's definitely not present
            if (!data.get(bitNo)) {
                return false;
            }
        }
        // All relevant bits set — likely in set
        return true;
    }
    ...
    public static final String LETTERS =
            "abcdefghijklmnopqrstuvexyABCDEFGHIJKLMNOPQRSTUVWYXZzÃ©Ã¨ÃªÃ Ã´Ã»";
